...
enum MarioAnimID
{
	...
	/* 0xD1 */ MARIO_ANIM_GROUND_HANDSTAND_INTO,
	/* 0xD2 */ MARIO_ANIM_GROUND_HANDSTAND_OUT,
	/* 0xD3 */ MARIO_ANIM_GROUND_HANDSTAND_IDLE,
	/* 0xD4 */ MARIO_ANIM_GROUND_HANDSTAND_WALKING
};
